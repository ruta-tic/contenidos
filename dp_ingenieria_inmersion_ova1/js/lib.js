...
dhbgApp.standard.start = function() {
    ...
    // ==============================================================================================
    dhbgApp.standard.fn_tooltip = function() {
    ...
    $('.tooltip').each(dhbgApp.standard.fn_tooltip);
...
dhbgApp.standard.load_operations = function() {
    ...
    dhbgApp.actions.activityQuiz = function ($this, options) {
        ...
        $this.find('question').each(function(){
            ...
            var q_feedbacktrue = dhbgApp.s('answer_corrent'), q_feedbackfalse = dhbgApp.s('answer_wrong');
            ...
            if(!activity.showPartialFeedback(activity.currentPagination)){
                ...
                if(activity.isFullAnswered()){
                    ...
                    if (count_questions > 1) {
                        ...
                        var $msg = $(msg);
                        $msg.find('.tooltip').each(dhbgApp.standard.fn_tooltip);
                        $box_end.empty();
