...
dhbgApp.standard.load_operations = function() {
    ...
    dhbgApp.actions.activityForm = function ($this) {
        ...
        var requireall = $this.attr('data-require-all') && $this.attr('data-require-all') != 'false';
        ...
        if (printable) {
            ...
            $print.on('click', function() {
                if (!activity.fullAnswered() && requireall){
                    $dialog_answer_required.dialog('open');
                }
                else {
        ...
        if (can_save && typeof dhbgApp.scorm == 'object' && dhbgApp.scorm.lms) {
            ...
            var $save = $('<button class="button general saveform">' + dhbgApp.s('save') + '</button>');
